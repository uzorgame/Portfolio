...
const translations = {
  en: {
    ...
    "date.ruta": "Nov 2025 – Present", "date.kora": "Feb 2026", "date.solar": "Dec 2025", "date.retro": "Oct – Nov 2025", "date.currency": "Oct 2025", "date.sudoku": "Sep – Oct 2025",
    "theme.light": "Light", "theme.dark": "Dark",
    "hero.eyebrow": "Nahreba Mykhailo · Bratislava · Open to work",
    "hero.title": "Design. Develop.<br>Ship.",
    "hero.subtitle": "Junior developer with my own apps, games and web products. Co-founder and active developer of RutaLive — a courier-logistics SaaS competing with major dispatch companies across the US and Canada.",
    "hero.proof": "<b>6</b> products · <b>4</b> platforms · <b>3</b> stores",
    ...
    "about.statement": "Mobile & Web Developer",
    "about.looking": "Open to full-time roles and product collaborations.",
    "about.focus": "Cross-platform",
    "journey.d1": "2025", "journey.t1": "First shipped products — Sudoku, Currency Converter+, Retro Arcade, 3D Solar System.",
    ...
    "other.solar.title": "3D Solar System", "other.solar.tag": "Available", "other.solar.platform": "Desktop only", "other.solar.desc": "A real-time, interactive 3D model of the Solar System rendered with Three.js and WebGL. Explore every planet, dwarf planet, moon, asteroid and comet on accurate orbits — control time, follow any body, and read live orbital data, all at 60fps in the browser with no install.",
    ...
    "about.title": "About Me", "about.bio": "Junior software developer building cross-platform products end to end — from concept to release on the app stores. Six products shipped across mobile, games and the web. Co-founder and active developer of RutaLive, a multi-tenant SaaS for courier logistics.",
    ...
    "common.privacyPolicy": "Privacy", "common.screenshots": "Screenshots", "common.windows": "Windows", "common.android": "Android", "common.website": "Website", "footer.text": "© 2026 Nahreba Mykhailo. Built with precision."
  },
  uk: {
    ...
    "date.ruta": "Листопад 2025 – зараз", "date.kora": "Лютий 2026", "date.solar": "Грудень 2025", "date.retro": "Жовтень – Листопад 2025", "date.currency": "Жовтень 2025", "date.sudoku": "Вересень – Жовтень 2025",
    ...
    "hero.subtitle": "Джун-розробник із власними застосунками, іграми та вебпродуктами. Співзасновник і активний розробник RutaLive — SaaS для курʼєрської логістики, що конкурує з великими диспетчерськими компаніями США та Канади.",
    "hero.proof": "<b>6</b> продуктів · <b>4</b> платформи · <b>3</b> сторі",
    ...
    "about.statement": "Мобайл- і веб-розробник",
    "about.looking": "Відкритий до фултайму та продуктових колаборацій.",
    "about.focus": "Кросплатформ",
    "journey.d1": "2025", "journey.t1": "Перші релізи — Sudoku, Currency Converter+, Retro Arcade, 3D Solar System.",
    ...
    "other.solar.title": "3D Solar System", "other.solar.tag": "Доступно", "other.solar.platform": "Тільки для ПК", "other.solar.desc": "Інтерактивна 3D-модель Сонячної системи в реальному часі на Three.js та WebGL. Досліджуй кожну планету, карликову планету, супутник, астероїд і комету на точних орбітах — керуй часом, слідуй за будь-яким тілом і читай живі орбітальні дані, 60fps просто в браузері, без встановлення.",
    ...
    "about.title": "Про мене", "about.bio": "Джуніор-розробник, який будує кросплатформні продукти від концепту до релізу в сторах. Шість випущених продуктів — мобільні застосунки, ігри та веб. Співзасновник і активний розробник RutaLive, багатотенантної SaaS для курʼєрської логістики.",
    ...
    "roadmap.solar.title": "3D Solar System — Випущено", "roadmap.solar.desc": "Інтерактивний веб-досвід доступний",
    ...
    "common.privacyPolicy": "Приватність", "common.screenshots": "Скриншоти", "common.windows": "Windows", "common.android": "Android", "common.website": "Сайт", "footer.text": "© 2026 Nahreba Mykhailo. Створено з точністю."
  }
};

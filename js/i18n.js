...
const translations = {
  en: {
    ...
    "other.solar.title": "3D Solar System", "other.solar.tag": "Available", "other.solar.desc": "A real-time, interactive 3D model of the Solar System rendered with Three.js and WebGL. Explore every planet, dwarf planet, moon, asteroid and comet on accurate orbits — control time, follow any body, and read live orbital data, all at 60fps in the browser with no install.",
    ...
    "about.title": "About Me", "about.bio": "Product engineer building cross-platform products end to end — from concept to release on the app stores. Six products shipped across mobile, games and the web. Co-founder and active developer of RutaLive, a multi-tenant SaaS for courier logistics.",
  ...
  uk: {
    ...
    "other.solar.title": "3D Solar System", "other.solar.tag": "Доступно", "other.solar.desc": "Інтерактивна 3D-модель Сонячної системи в реальному часі на Three.js та WebGL. Досліджуй кожну планету, карликову планету, супутник, астероїд і комету на точних орбітах — керуй часом, слідуй за будь-яким тілом і читай живі орбітальні дані, 60fps просто в браузері, без встановлення.",
    ...
    "about.title": "Про мене", "about.bio": "Продуктовий інженер, який будує кросплатформні продукти від концепту до релізу в сторах. Шість випущених продуктів — мобільні застосунки, ігри та веб. Співзасновник і активний розробник RutaLive, багатотенантної SaaS для курʼєрської логістики.",
